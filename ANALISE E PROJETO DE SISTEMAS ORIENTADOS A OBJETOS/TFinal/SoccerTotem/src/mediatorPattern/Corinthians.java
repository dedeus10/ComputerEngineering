 ...
 * 
 * @author dedeus
 *@class public class Corinthians extends Colleague
 ...
 */
public class Corinthians extends Colleague {
	/**
	...
	final double valorCampo = 150;
	final double valorChurras = 20;
	final double valorAssador = 10;
	...
	public void receberMensagem(String mensagem) {
		...
		System.out.println("Corinthians recebeu: " + mensagem);
	}
	...
	public void proposedAnalysis(soccerGame game) {
		...
		System.out.println("\n");
		System.out.println("---Disponibilidade para jogos em: Corinthians---");
