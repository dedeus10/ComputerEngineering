 ...
 * 
 * @author dedeus
 *@class public class DallaFavera extends Colleague
 ...
 */
public class DallaFavera extends Colleague {
	 ...
	 */
	final double valorQuadra = 100;
	final double valorCampo = 140;
	final double valorChurras = 40;
	final double valorAssador = 20;
	...
	public void receberMensagem(String mensagem) {
		...
		System.out.println("Dalla Favera recebeu: " + mensagem);
	}
	...
	public void proposedAnalysis(soccerGame game) {
		...
		System.out.println("\n");
		System.out.println("---Disponibilidade para jogos em: Dalla Favera---");
