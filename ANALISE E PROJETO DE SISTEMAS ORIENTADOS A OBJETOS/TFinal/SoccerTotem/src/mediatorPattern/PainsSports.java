 ...
 * 
 * @author dedeus
 *@class public class PainsSports extends Colleague
 ...
 */
public class PainsSports extends Colleague {
	 ...
	 */
	final double valorQuadra = 90;
	final double valorCampo = 110;
	final double valorChurras = 60;
	final double valorAssador = 30;
	...
	public void receberMensagem(String mensagem) {
		...
		System.out.println("PainsSports recebeu: " + mensagem);
	}
	...
	public void proposedAnalysis(soccerGame game) {
		...
		System.out.println("\n");
		System.out.println("---Disponibilidade para jogos em: Pains Sports---");
