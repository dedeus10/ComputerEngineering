 ...
 * 
 * @author dedeus
 *\file twentyBucks.java
 *
 *Classe é a implementação de um slot do padrão 
 *Chain of Responsability
 *Slot de cédulas de R$20,00

/**
 * 
 * @author dedeus
 *@class public class twentyBucks implements Slots
 *@brief Classe implementa o padrão Chain of Responsability sendo um slot pra cédulas de R$20,00
 */
public class twentyBucks implements Slots{

	/**
	 * @var sucessor é um objeto do tipo Slot que representa o sucessor do slot de 20 na Chain
	 * @var moneyPlace é um objeto do tipo Bank que representa o Banco que esta Chain esta associada
	 * @def TWENTYNBUCKS constante que representa o valor deste slot
	 */
	private Slots sucessor;
	private Bank moneyPlace;
	private final Integer TWENTYNBUCKS = 20;
	...
	public String toString() {
		return "Twenty Bucks [sucessor=" + sucessor + "]";
	}
