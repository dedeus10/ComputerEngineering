 ...
 *Slot de cédulas de R$2,00
*/

/**
 * 
 * @author dedeus
 *@class public class twoBucks implements Slots
 *@brief Classe implementa o padrão Chain of Responsability sendo um slot pra cédulas de R$2,00
 */
public class twoBucks implements Slots{

	/**
	 * @var sucessor é um objeto do tipo Slot que representa o sucessor do slot de 2 na Chain
	 * @var moneyPlace é um objeto do tipo Bank que representa o Banco que esta Chain esta associada
	 * @def TWOBUCKS constante que representa o valor deste slot
	 */
	private Slots sucessor;
	private Bank moneyPlace;
	private final Integer TWOBUCKS = 2;
	...
	public String toString() {
		return "Two Bucks [sucessor=" + sucessor + "]";
	}
