 ...
 *Slot de cédulas de R$5,00

/**
 * 
 * @author dedeus
 *@class public class fiveBucks implements Slots
 *@brief Classe implementa o padrão Chain of Responsability sendo um slot pra cédulas de R$5,00
 */
public class fiveBucks implements Slots{

	/**
	 * @var sucessor é um objeto do tipo Slot que representa o sucessor do slot de 5 na Chain
	 * @var moneyPlace é um objeto do tipo Bank que representa o Banco que esta Chain esta associada
	 * @def FIVEBUCKS constante que representa o valor deste slot
	 */
	private Slots sucessor;
	private Bank moneyPlace;
	private final Integer FIVEBUCKS = 5;
	...
	public String toString() {
		return "Five Bucks [sucessor=" + sucessor + "]";
	}
