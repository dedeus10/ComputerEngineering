 ...
 * 
 * @author dedeus
 *\file fiftyBucks.java
 *
 *Classe é a implementação de um slot do padrão 
 *Chain of Responsability
 *Slot de cédulas de R$50,00

/**
 * 
 * @author dedeus
 *@class public class fiftyBucks implements Slots
 *@brief Classe implementa o padrão Chain of Responsability sendo um slot pra cédulas de R$50,00
 */
public class fiftyBucks implements Slots{
	
	/**
	 * @var sucessor é um objeto do tipo Slot que representa o sucessor do slot de 50 na Chain
	 * @var moneyPlace é um objeto do tipo Bank que representa o Banco que esta Chain esta associada
	 * @def FIFTYBUCKS constante que representa o valor deste slot, no caso 50
	 */
	private Slots sucessor;
	private Bank moneyPlace;
	private final Integer FIFTYBUCKS = 50;
	...
	public String toString() {
		return "Fifty Bucks [sucessor=" + sucessor + "]";
	}
