 ...
 * 
 * @author dedeus
 *\file hundredBucks.java
 *
 *Classe é a implementação de um slot do padrão 
 *Chain of Responsability
 *Slot de cédulas de R$100,00

/**
 * 
 * @author dedeus
 *@class class hundredBucks implements Slots
 *@brief Classe implementa o padrão Chain of Responsability sendo um slot pra cédulas de R$100,00
 */
public class hundredBucks implements Slots{

	/**
	 * @var sucessor é um objeto do tipo Slot que representa o sucessor do slot de 100 na Chain
	 * @var moneyPlace é um objeto do tipo Bank que representa o Banco que esta Chain esta associada
	 * @def HUNDREDBUCKS constante que representa o valor deste slot
	 */
	private Slots sucessor;
	private Bank moneyPlace;
	private final Integer HUNDREDBUCKS = 100;
	...
	public String toString() {
		return "Hundred Bucks [sucessor=" + sucessor + "]";
	}
