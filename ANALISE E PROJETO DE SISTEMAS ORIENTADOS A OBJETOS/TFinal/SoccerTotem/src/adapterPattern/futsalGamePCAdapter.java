 ...
 *de jogos do tipo de futsal com adicional de churrasco
 */

/**
 * 
 * @author dedeus
 *@class public class futsalGamePCAdapter extends futsalGamePlusChurras implements gameTarget 
 *@brief Classe é um adaptador para jogos de futebol de futsal com adicional de churrasco
 */
public class futsalGamePCAdapter extends futsalGamePlusChurras implements gameTarget {
