 ...
 *de jogos do tipo de campo com churrasco
 */

/**
 * 
 * @author dedeus
 *@class public class fieldGamePCAdapter extends fieldGamePlusChurras implements gameTarget
 *@brief Classe é um adaptador para jogos de futebol de campo com adicional de churrasco
 */
public class fieldGamePCAdapter extends fieldGamePlusChurras implements gameTarget {
