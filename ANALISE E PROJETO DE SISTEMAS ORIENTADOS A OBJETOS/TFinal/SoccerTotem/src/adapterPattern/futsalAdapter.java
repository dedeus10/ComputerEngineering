 ...
 *de jogos do tipo de futsal
 */

/**
 * 
 * @author dedeus
 *@class public class futsalAdapter extends futsalGame implements gameTarget
 *@brief Classe é um adaptador para jogos de futebol de futsal
 */
public class futsalAdapter extends futsalGame implements gameTarget {
