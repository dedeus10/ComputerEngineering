 ...
 *de jogos do tipo de campo
 */

/**
 * 
 * @author dedeus
 *@class public class fieldGameAdapter extends fieldGame implements gameTarget
 *@brief Classe é um adaptador para jogos de futebol de campo
 */
public class fieldGameAdapter extends fieldGame implements gameTarget {
