 ...
 * 
 * @author dedeus
 *@class public class futsalGame extends soccerGame
 *@brief Classe implementa o padrão Template criando um jogo de quadra extendendo um jogo de futebol
 */
public class futsalGame extends soccerGame {
	/**
	...
	public String toString() {
		return "futsalGame [churras=" + churras + ", assador=" + assador + ", local=" + local + ", codigo=" + codigo
				+ ", colleague=" + colleague + "]";
	}
