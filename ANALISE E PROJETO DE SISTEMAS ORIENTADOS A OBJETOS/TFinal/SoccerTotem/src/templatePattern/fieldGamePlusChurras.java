 ...
 * 
 * @author dedeus
 *\file fieldGamePlusChurras.java
 *
 ...
 * 
 * @author dedeus
 *@class public class fieldGamePlusChurras extends soccerGame
 *@brief Classe implementa o padrão Template criando um jogo de campo comm churrasco extendendo um jogo de futebol
 */
public class fieldGamePlusChurras extends soccerGame{
	/**
	...
	public String toString() {
		return "fieldGamePlusChurras [churras=" + churras + ", assador=" + assador + ", local=" + local + ", codigo="
				+ codigo + ", colleague=" + colleague + "]";
	}
