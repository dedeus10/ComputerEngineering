 ...
 * 
 * @author dedeus
 *\file fieldGamePlusChurrasPlusAssador.java
 *
 ...
 * 
 * @author dedeus
 *@class public class fieldGamePlusChurrasPlusAssador extends soccerGame
 *@brief Classe implementa o padrão Template criando um jogo de campo com churrasco e com assador extendendo um jogo de futebol
 */
public class fieldGamePlusChurrasPlusAssador extends soccerGame{
	/**
	...
	public String toString() {
		return "fieldGamePlusChurrasPlusAssador [churras=" + churras + ", assador=" + assador + ", local=" + local
