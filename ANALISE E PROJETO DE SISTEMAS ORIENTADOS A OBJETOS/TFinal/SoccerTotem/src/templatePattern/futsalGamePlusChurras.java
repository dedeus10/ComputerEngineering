...
* 
* @author dedeus
*\file futsalGamePlusChurras.java
*
...
* 
* @author dedeus
*@class public class futsalGamePlusChurras extends soccerGame
*@brief Classe implementa o padrão Template criando um jogo de quadra com churrasco
* extendendo um jogo de futebol
*/
public class futsalGamePlusChurras extends soccerGame{
	/**
	...
	public String toString() {
		return "futsalGamePlusChurras [churras=" + churras + ", assador=" + assador + ", local=" + local + ", codigo="
